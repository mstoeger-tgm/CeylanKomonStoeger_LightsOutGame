...
public class Schalter extends JPanel implements MouseListener{
	...
	/**
	 * Konstruktor fuer den Schalter
	 * Benoetigt als Paramter:
	 * isOn <- ob der Schalter beim erstellen eingeschalten sein soll
	 * num <- Fortlaufende Nummerierung der Schalter
	 * @param isOn
	 * @param num
	 * @param g
	 */
